(function() {
    ...
    function generatedStrengthChanged() {
        ...
        if (strength < 12) {
            DOM.generatedStrengthWarning.removeClass("visually-hidden");
        }
        else {
            DOM.generatedStrengthWarning.addClass("visually-hidden");
        }
    }
    ...
    function networkChanged(e) {
        clearDerivedKeys();
        clearAddressesList();
        DOM.litecoinLtubContainer.addClass("visually-hidden");
        DOM.bitcoinCashAddressTypeContainer.addClass("visually-hidden");
    ...
    function setEntropyVisibility() {
        if (isUsingOwnEntropy()) {
            DOM.entropyContainer.removeClass("visually-hidden");
            DOM.generateContainer.addClass("visually-hidden");
            DOM.phrase.prop("readonly", true);
            DOM.entropy.focus();
            entropyChanged();
        }
        else {
            DOM.entropyContainer.addClass("visually-hidden");
            DOM.generateContainer.removeClass("visually-hidden");
    ...
    function toggleSplitMnemonic() {
        if (DOM.showSplitMnemonic.prop("checked")) {
            DOM.splitMnemonic.removeClass("visually-hidden");
        }
        else {
            DOM.splitMnemonic.addClass("visually-hidden");
        }
    }

    function toggleBip85() {
      if (DOM.showBip85.prop('checked')) {
        DOM.bip85.removeClass('visually-hidden');
        calcBip85();
      } else {
        DOM.bip85.addClass('visually-hidden');
      }
    }

    function toggleBip85Fields() {
      if (DOM.showBip85.prop('checked')) {
        DOM.bip85mnemonicLanguageInput.addClass('visually-hidden');
        DOM.bip85mnemonicLengthInput.addClass('visually-hidden');
        DOM.bip85bytesInput.addClass('visually-hidden');

        var app = DOM.bip85application.val();
        if (app === 'bip39') {
          DOM.bip85mnemonicLanguageInput.removeClass('visually-hidden');
          DOM.bip85mnemonicLengthInput.removeClass('visually-hidden');
        } else if (app === 'hex') {
          DOM.bip85bytesInput.removeClass('visually-hidden');
        }
      }
    }
    ...
    function setMnemonicFromEntropy() {
        ...
        if (mnemonicLength != "raw") {
            ...
            if (mnemonicLength / 3 * 32 > entropy.binaryStr.length) {
                DOM.entropyWeakEntropyOverrideWarning.removeClass("visually-hidden");
            }
            else {
                DOM.entropyWeakEntropyOverrideWarning.addClass("visually-hidden");
            }
        }
        else {
    ...
    function showEntropyFeedback(entropy) {
        ...
        if (isFiltered) {
            DOM.entropyFilterWarning.removeClass('visually-hidden');
        }
        else {
            DOM.entropyFilterWarning.addClass('visually-hidden');
        }
    }
    ...
    function createQr(e) {
        ...
        if (content) {
            ...
            if (!showQr) {
                DOM.qrHider.addClass("visually-hidden");
            }
            else {
                DOM.qrHider.removeClass("visually-hidden");
            }
            DOM.qrContainer.removeClass("visually-hidden");
        }
    }

    function destroyQr() {
        DOM.qrImage.text("");
        DOM.qrContainer.addClass("visually-hidden");
    }

    function toggleQr() {
        showQr = !showQr;
        DOM.qrHider.toggleClass("visually-hidden");
        DOM.qrHint.toggleClass("visually-hidden");
    }

    function bip44TabSelected() {
        return DOM.bip44tab.find("button").hasClass("active");
    }

    function bip32TabSelected() {
        return DOM.bip32tab.find("button").hasClass("active");
    }
    ...
    function bip49TabSelected() {
        return DOM.bip49tab.find("button").hasClass("active");
    }

    function bip84TabSelected() {
        return DOM.bip84tab.find("button").hasClass("active");
    }

    function bip141TabSelected() {
        return DOM.bip141tab.find("button").hasClass("active");
    }
    ...
    function showSegwitAvailable() {
        DOM.bip49unavailable.addClass("visually-hidden");
        DOM.bip49available.removeClass("visually-hidden");
        DOM.bip84unavailable.addClass("visually-hidden");
        DOM.bip84available.removeClass("visually-hidden");
        DOM.bip141unavailable.addClass("visually-hidden");
        DOM.bip141available.removeClass("visually-hidden");
    }

    function showSegwitUnavailable() {
        DOM.bip49available.addClass("visually-hidden");
        DOM.bip49unavailable.removeClass("visually-hidden");
        DOM.bip84available.addClass("visually-hidden");
        DOM.bip84unavailable.removeClass("visually-hidden");
        DOM.bip141available.addClass("visually-hidden");
        DOM.bip141unavailable.removeClass("visually-hidden");
    }
    ...
    var networks = [
        ...
        },
        {
            ...
            onSelect: function() {
                DOM.bitcoinCashAddressTypeContainer.removeClass("visually-hidden");
                setHdCoin(145);
            },
        },
        {
        ...
        },
        {
            ...
            onSelect: function() {
                network = libs.bitcoin.networks.litecoin;
                setHdCoin(2);
                DOM.litecoinLtubContainer.removeClass("visually-hidden");
            },
        },
        {
